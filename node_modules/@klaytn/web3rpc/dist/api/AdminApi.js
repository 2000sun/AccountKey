...
var AdminApi = exports["default"] = /*#__PURE__*/function () {
  ...
  */
  ...
  _createClass(AdminApi, [{
    ...
    /**
     * Callback function to receive the result of the nodeConfig operation.
     * @callback module:api/AdminApi~nodeConfigCallback
     * @param {String} error Error message, if any.
     * @param {module:model/NodeConfig200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */

    /**
     * [nodeConfig]
     * A series of node configurations  **JSONRPC:** `admin_nodeConfig` 
     * @param {Object} opts Optional parameters
     * @param {module:model/NodeConfigRequest} opts.nodeConfigRequest 
     * @param {module:api/AdminApi~nodeConfigCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/NodeConfig200Response}
     */
  }, {
    key: "nodeConfig",
    value: function nodeConfig(opts, callback) {
      opts = opts || {};
      var postBody = new _NodeConfigRequest["default"](undefined, undefined, undefined);
      var optsIndex = 0;
      postBody.params = [];
      var authNames = [];
      var contentTypes = ['application/json'];
      var accepts = ['application/json'];
      var returnType = _NodeConfig200Response["default"];
      return this.apiClient.callApi('/admin/nodeConfig', 'POST', null, null, null, null, postBody, authNames, contentTypes, accepts, returnType, null, callback);
    }
