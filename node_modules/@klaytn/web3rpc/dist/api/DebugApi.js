...
var DebugApi = exports["default"] = /*#__PURE__*/function () {
  ...
  */
  ...
  _createClass(DebugApi, [{
    ...
    /**
     * Callback function to receive the result of the traceCall operation.
     * @callback module:api/DebugApi~traceCallCallback
     * @param {String} error Error message, if any.
     * @param {module:model/TraceCall200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */

    /**
     * [Trace-traceCall]
     * The debug_traceCall allows tracing on a specific block if callArgs is provided.  **JSONRPC:** `debug_traceCall` 
     * @param {Object.<String, module:model/TracerCallObject>} tracerCallObject The transaction call object.
     * @param {module:model/BlockNumberOrHashOrTag} blockNumber Blocknumber or hash or tag of a block.
     * @param {Object.<String, module:model/TracerObject>} traceObject Tracing options.
     * @param {Object} opts Optional parameters
     * @param {module:model/TraceCallRequest} opts.traceCallRequest 
     * @param {module:api/DebugApi~traceCallCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/TraceCall200Response}
     */
  }, {
    key: "traceCall",
    value: function traceCall(tracerCallObject, blockNumber, traceObject, opts, callback) {
      opts = opts || {};
      // verify the required parameter 'tracerCallObject' is set
      if (tracerCallObject === undefined || tracerCallObject === null) {
        throw new Error("Missing the required parameter 'tracerCallObject' when calling traceCall");
      }
      // verify the required parameter 'blockNumber' is set
      if (blockNumber === undefined || blockNumber === null) {
        throw new Error("Missing the required parameter 'blockNumber' when calling traceCall");
      }
      // verify the required parameter 'traceObject' is set
      if (traceObject === undefined || traceObject === null) {
        throw new Error("Missing the required parameter 'traceObject' when calling traceCall");
      }
      var postBody = new _TraceCallRequest["default"](undefined, undefined, undefined);
      var optsIndex = 0;
      postBody.params = [];
      postBody.params.push(tracerCallObject);
      postBody.params.push(blockNumber);
      postBody.params.push(traceObject);
      var authNames = [];
      var contentTypes = ['application/json'];
      var accepts = ['application/json'];
      var returnType = _TraceCall200Response["default"];
      return this.apiClient.callApi('/debug/vMTracing/traceCall', 'POST', null, null, null, null, postBody, authNames, contentTypes, accepts, returnType, null, callback);
    }
