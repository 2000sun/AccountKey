...
var ApiClient = /*#__PURE__*/function () {
   ...
   */
  function ApiClient() {
    var basePath = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'http://localhost:8551';
     ...
     */
    this.defaultHeaders = {
      'User-Agent': 'OpenAPI-Generator/0.9.9/Javascript'
    };
  ...
  _createClass(ApiClient, [{
    ...
    */
    ...
    value: function deserialize(response, returnType) {
      ...
      if ((_data = data) !== null && _data !== void 0 && _data.error) return data.error;
      return data.result;
    }
