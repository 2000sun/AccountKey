 ...
 */
/**
 * The TxTypeFeeDelegatedSmartContractDeploy model module.
 * @module model/TxTypeFeeDelegatedSmartContractDeploy
 * @version 0.9.9
 */
var TxTypeFeeDelegatedSmartContractDeploy = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>TxTypeFeeDelegatedSmartContractDeploy</code>.
   * @alias module:model/TxTypeFeeDelegatedSmartContractDeploy
   * @param typeInt {Number} The integer indicating TxTypeFeeDelegatedSmartContractDeploy: 41
   ...
   */
  function TxTypeFeeDelegatedSmartContractDeploy(typeInt, from, to, value, input, humanReadable, codeFormat, feePayer) {
    _classCallCheck(this, TxTypeFeeDelegatedSmartContractDeploy);
    TxTypeFeeDelegatedSmartContractDeploy.initialize(this, typeInt, from, to, value, input, humanReadable, codeFormat, feePayer);
  }
   ...
   */
  _createClass(TxTypeFeeDelegatedSmartContractDeploy, null, [{
    key: "initialize",
    value: function initialize(obj, typeInt, from, to, value, input, humanReadable, codeFormat, feePayer) {
      obj['typeInt'] = typeInt;
      obj['from'] = from;
      obj['to'] = to;
      obj['value'] = value;
    ...
    /**
     * Constructs a <code>TxTypeFeeDelegatedSmartContractDeploy</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TxTypeFeeDelegatedSmartContractDeploy} obj Optional instance to populate.
     * @return {module:model/TxTypeFeeDelegatedSmartContractDeploy} The populated <code>TxTypeFeeDelegatedSmartContractDeploy</code> instance.
     */
  }, {
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new TxTypeFeeDelegatedSmartContractDeploy();
    ...
    /**
     * Validates the JSON data with respect to <code>TxTypeFeeDelegatedSmartContractDeploy</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TxTypeFeeDelegatedSmartContractDeploy</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(TxTypeFeeDelegatedSmartContractDeploy.RequiredProperties),
        _step;
      try {
...
TxTypeFeeDelegatedSmartContractDeploy.RequiredProperties = ["typeInt", "from", "to", "value", "input", "humanReadable", "codeFormat", "feePayer"];

/**
 * The integer indicating TxTypeFeeDelegatedSmartContractDeploy: 41
 * @member {Number} typeInt
 */
TxTypeFeeDelegatedSmartContractDeploy.prototype['typeInt'] = undefined;

/**
 * The address from which the transaction is sent.
 * @member {String} from
 */
TxTypeFeeDelegatedSmartContractDeploy.prototype['from'] = undefined;

/**
 * The address to which the transaction is directed.
 * @member {String} to
 */
TxTypeFeeDelegatedSmartContractDeploy.prototype['to'] = undefined;
 ...
 * @member {String} gas
 */
TxTypeFeeDelegatedSmartContractDeploy.prototype['gas'] = undefined;

/**
 * (optional, default: 25000000000 Peb) Integer of the gasPrice used for each paid gas.
 * @member {String} gasPrice
 */
TxTypeFeeDelegatedSmartContractDeploy.prototype['gasPrice'] = undefined;

/**
 * (optional) Integer of a nonce.
 * @member {String} nonce
 */
TxTypeFeeDelegatedSmartContractDeploy.prototype['nonce'] = undefined;

/**
 * Integer of the value sent with this transaction.
 * @member {String} value
 */
TxTypeFeeDelegatedSmartContractDeploy.prototype['value'] = undefined;

/**
 * The data sent along with the transaction.
 * @member {String} input
 */
TxTypeFeeDelegatedSmartContractDeploy.prototype['input'] = undefined;
 ...
 */
TxTypeFeeDelegatedSmartContractDeploy.prototype['humanReadable'] = undefined;

/**
 * The code format of smart contract code. The value 0 indicates EVM.
 * @member {String} codeFormat
 */
TxTypeFeeDelegatedSmartContractDeploy.prototype['codeFormat'] = undefined;

/**
 * The fee payer address of the transaction.
 * @member {String} feePayer
 */
TxTypeFeeDelegatedSmartContractDeploy.prototype['feePayer'] = undefined;
 ...
 */
TxTypeFeeDelegatedSmartContractDeploy.prototype['signatures'] = undefined;
var _default = exports["default"] = TxTypeFeeDelegatedSmartContractDeploy;