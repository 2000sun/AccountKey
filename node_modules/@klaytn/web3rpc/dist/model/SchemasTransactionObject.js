 ...
 */
/**
 * The SchemasTransactionObject model module.
 * @module model/SchemasTransactionObject
 * @version 0.9.9
 */
var SchemasTransactionObject = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>SchemasTransactionObject</code>.
   * @alias module:model/SchemasTransactionObject
   * @param blockHash {String} Hash of the block where this transaction was in.
   * @param blockNumber {String} The block number where this transaction was in.
   * @param contractAddress {String} The contract address created, if the transaction was a contract creation, otherwise null.
   * @param feePayer {String} Address of the fee payer.
   * @param feePayerSignatures {Array.<module:model/Signature>} An array of fee payer's signature objects. A signature object contains three fields (V, R, and S). V contains ECDSA recovery id. R contains ECDSA signature r while S contains ECDSA signature s.
   ...
   * @param gasUsed {String} The amount of gas used by this specific transaction alone.
   * @param logs {Array.<Object>} Array of log objects, which this transaction generated.
   * @param logsBloom {String} Bloom filter for light clients to quickly retrieve related logs.
   * @param nonce {String} The number of transactions made by the sender prior to this one.
   * @param senderTxHash {String} Hash of the tx without the fee payer's address and signature. This value is always the same as the value of transactionHash for non fee-delegated transactions.
   * @param status {String} Either 1 (success) or 0 (failure).
   ...
   * @param transactionIndex {String} Integer of the transaction index position in the block.
   ...
   */
  function SchemasTransactionObject(blockHash, blockNumber, contractAddress, feePayer, feePayerSignatures, from, gas, gasPrice, gasUsed, logs, logsBloom, nonce, senderTxHash, status, to, transactionHash, transactionIndex, type, typeInt, value) {
    _classCallCheck(this, SchemasTransactionObject);
    SchemasTransactionObject.initialize(this, blockHash, blockNumber, contractAddress, feePayer, feePayerSignatures, from, gas, gasPrice, gasUsed, logs, logsBloom, nonce, senderTxHash, status, to, transactionHash, transactionIndex, type, typeInt, value);
  }
   ...
   */
  _createClass(SchemasTransactionObject, null, [{
    key: "initialize",
    value: function initialize(obj, blockHash, blockNumber, contractAddress, feePayer, feePayerSignatures, from, gas, gasPrice, gasUsed, logs, logsBloom, nonce, senderTxHash, status, to, transactionHash, transactionIndex, type, typeInt, value) {
      obj['blockHash'] = blockHash;
      obj['blockNumber'] = blockNumber;
      obj['contractAddress'] = contractAddress;
      obj['feePayer'] = feePayer;
      obj['feePayerSignatures'] = feePayerSignatures;
      obj['from'] = from;
      obj['gas'] = gas;
    ...
    /**
     * Constructs a <code>SchemasTransactionObject</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SchemasTransactionObject} obj Optional instance to populate.
     * @return {module:model/SchemasTransactionObject} The populated <code>SchemasTransactionObject</code> instance.
     */
  }, {
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new SchemasTransactionObject();
        ...
        if (data.hasOwnProperty('logs')) {
          obj['logs'] = _ApiClient["default"].convertToType(data['logs'], [Object]);
        }
        ...
        if (data.hasOwnProperty('signature')) {
          obj['signature'] = _ApiClient["default"].convertToType(data['signature'], [_Signature["default"]]);
        }
        if (data.hasOwnProperty('status')) {
          obj['status'] = _ApiClient["default"].convertToType(data['status'], 'String');
        }
        if (data.hasOwnProperty('txError')) {
          obj['txError'] = _ApiClient["default"].convertToType(data['txError'], 'String');
        }
    ...
    /**
     * Validates the JSON data with respect to <code>SchemasTransactionObject</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SchemasTransactionObject</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(SchemasTransactionObject.RequiredProperties),
        _step;
      try {
      ...
      if (data['signature']) {
        ...
        if (!Array.isArray(data['signature'])) {
          throw new Error("Expected the field `signature` to be an array in the JSON data but got " + data['signature']);
        }
        // validate the optional field `signature` (array)
        var _iterator3 = _createForOfIteratorHelper(data['signature']),
          _step3;
        try {
      ...
      // ensure the json data is a string
      if (data['txError'] && !(typeof data['txError'] === 'string' || data['txError'] instanceof String)) {
        throw new Error("Expected the field `txError` to be a primitive type in the JSON string but got " + data['txError']);
      }
      // ensure the json data is a string
  ...
  return SchemasTransactionObject;
}();
SchemasTransactionObject.RequiredProperties = ["blockHash", "blockNumber", "contractAddress", "feePayer", "feePayerSignatures", "from", "gas", "gasPrice", "gasUsed", "logs", "logsBloom", "nonce", "senderTxHash", "status", "to", "transactionHash", "transactionIndex", "type", "typeInt", "value"];

/**
 * Hash of the block where this transaction was in.
 * @member {String} blockHash
 */
SchemasTransactionObject.prototype['blockHash'] = undefined;

/**
 * The block number where this transaction was in.
 * @member {String} blockNumber
 */
SchemasTransactionObject.prototype['blockNumber'] = undefined;

/**
 * (optional) The code format of smart contract code.
 * @member {String} codeFormat
 */
SchemasTransactionObject.prototype['codeFormat'] = undefined;

/**
 * The contract address created, if the transaction was a contract creation, otherwise null.
 * @member {String} contractAddress
 */
SchemasTransactionObject.prototype['contractAddress'] = undefined;

/**
 * Address of the fee payer.
 * @member {String} feePayer
 */
SchemasTransactionObject.prototype['feePayer'] = undefined;
 ...
 */
SchemasTransactionObject.prototype['feePayerSignatures'] = undefined;
 ...
 */
SchemasTransactionObject.prototype['feeRatio'] = undefined;

/**
 * Address of the sender.
 * @member {String} from
 */
SchemasTransactionObject.prototype['from'] = undefined;

/**
 * Gas provided by the sender.
 * @member {String} gas
 */
SchemasTransactionObject.prototype['gas'] = undefined;

/**
 * Gas price provided by the sender in peb.
 * @member {String} gasPrice
 */
SchemasTransactionObject.prototype['gasPrice'] = undefined;

/**
 * The amount of gas used by this specific transaction alone.
 * @member {String} gasUsed
 */
SchemasTransactionObject.prototype['gasUsed'] = undefined;

/**
 * (optional) true if the address is humanReadable, false if the address is not humanReadable.
 * @member {Boolean} humanReadable
 */
SchemasTransactionObject.prototype['humanReadable'] = undefined;

/**
 * (optional) Key of the newly created account.
 * @member {String} key
 */
SchemasTransactionObject.prototype['key'] = undefined;

/**
 * (optional) The data sent along with the transaction.
 * @member {String} input
 */
SchemasTransactionObject.prototype['input'] = undefined;

/**
 * Array of log objects, which this transaction generated.
 * @member {Array.<Object>} logs
 */
SchemasTransactionObject.prototype['logs'] = undefined;

/**
 * Bloom filter for light clients to quickly retrieve related logs.
 * @member {String} logsBloom
 */
SchemasTransactionObject.prototype['logsBloom'] = undefined;

/**
 * The number of transactions made by the sender prior to this one.
 * @member {String} nonce
 */
SchemasTransactionObject.prototype['nonce'] = undefined;
 ...
 */
SchemasTransactionObject.prototype['senderTxHash'] = undefined;
 ...
 * @member {Array.<module:model/Signature>} signature
 */
SchemasTransactionObject.prototype['signature'] = undefined;

/**
 * Either 1 (success) or 0 (failure).
 * @member {String} status
 */
SchemasTransactionObject.prototype['status'] = undefined;

/**
 * (optional) detailed error code if status is equal to zero.
 * @member {String} txError
 */
SchemasTransactionObject.prototype['txError'] = undefined;

/**
 * Address of the receiver. null when it is a contract creation transaction.
 * @member {String} to
 */
SchemasTransactionObject.prototype['to'] = undefined;

/**
 * Hash of the transaction.
 * @member {String} transactionHash
 */
SchemasTransactionObject.prototype['transactionHash'] = undefined;

/**
 * Integer of the transaction index position in the block.
 * @member {String} transactionIndex
 */
SchemasTransactionObject.prototype['transactionIndex'] = undefined;

/**
 * A string representing the type of the transaction.
 * @member {String} type
 */
SchemasTransactionObject.prototype['type'] = undefined;

/**
 * An integer representing the type of the transaction.
 * @member {Number} typeInt
 */
SchemasTransactionObject.prototype['typeInt'] = undefined;

/**
 * Value transferred in peb.
 * @member {String} value
 */
SchemasTransactionObject.prototype['value'] = undefined;
var _default = exports["default"] = SchemasTransactionObject;