 ...
 */
/**
 * The TxTypeFeeDelegatedValueTransferMemoWithRatio model module.
 * @module model/TxTypeFeeDelegatedValueTransferMemoWithRatio
 * @version 0.9.9
 */
var TxTypeFeeDelegatedValueTransferMemoWithRatio = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>TxTypeFeeDelegatedValueTransferMemoWithRatio</code>.
   ...
   * @alias module:model/TxTypeFeeDelegatedValueTransferMemoWithRatio
   * @param typeInt {Number} The integer indicating TxTypeFeeDelegatedValueTransferMemoWithRatio 18
   ...
   */
  function TxTypeFeeDelegatedValueTransferMemoWithRatio(typeInt, from, to, value, input, feePayer, feeRatio) {
    _classCallCheck(this, TxTypeFeeDelegatedValueTransferMemoWithRatio);
    TxTypeFeeDelegatedValueTransferMemoWithRatio.initialize(this, typeInt, from, to, value, input, feePayer, feeRatio);
  }
   ...
   */
  _createClass(TxTypeFeeDelegatedValueTransferMemoWithRatio, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>TxTypeFeeDelegatedValueTransferMemoWithRatio</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TxTypeFeeDelegatedValueTransferMemoWithRatio} obj Optional instance to populate.
     * @return {module:model/TxTypeFeeDelegatedValueTransferMemoWithRatio} The populated <code>TxTypeFeeDelegatedValueTransferMemoWithRatio</code> instance.
     */
  }, {
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new TxTypeFeeDelegatedValueTransferMemoWithRatio();
    ...
    /**
     * Validates the JSON data with respect to <code>TxTypeFeeDelegatedValueTransferMemoWithRatio</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TxTypeFeeDelegatedValueTransferMemoWithRatio</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(TxTypeFeeDelegatedValueTransferMemoWithRatio.RequiredProperties),
        _step;
      try {
...
TxTypeFeeDelegatedValueTransferMemoWithRatio.RequiredProperties = ["typeInt", "from", "to", "value", "input", "feePayer", "feeRatio"];

/**
 * The integer indicating TxTypeFeeDelegatedValueTransferMemoWithRatio 18
 * @member {Number} typeInt
 */
TxTypeFeeDelegatedValueTransferMemoWithRatio.prototype['typeInt'] = undefined;

/**
 * The address from which the transaction is sent.
 * @member {String} from
 */
TxTypeFeeDelegatedValueTransferMemoWithRatio.prototype['from'] = undefined;

/**
 * The address to which the transaction is directed.
 * @member {String} to
 */
TxTypeFeeDelegatedValueTransferMemoWithRatio.prototype['to'] = undefined;
 ...
 * @member {String} gas
 */
TxTypeFeeDelegatedValueTransferMemoWithRatio.prototype['gas'] = undefined;

/**
 * (optional, default 25000000000 Peb) Integer of the gasPrice used for each paid gas.
 * @member {String} gasPrice
 */
TxTypeFeeDelegatedValueTransferMemoWithRatio.prototype['gasPrice'] = undefined;

/**
 * (optional) Integer of a nonce.
 * @member {String} nonce
 */
TxTypeFeeDelegatedValueTransferMemoWithRatio.prototype['nonce'] = undefined;

/**
 * Integer of the value sent with this transaction.
 * @member {String} value
 */
TxTypeFeeDelegatedValueTransferMemoWithRatio.prototype['value'] = undefined;

/**
 * The data sent along with the transaction.
 * @member {String} input
 */
TxTypeFeeDelegatedValueTransferMemoWithRatio.prototype['input'] = undefined;

/**
 * The fee payer address of the transaction.
 * @member {String} feePayer
 */
TxTypeFeeDelegatedValueTransferMemoWithRatio.prototype['feePayer'] = undefined;
 ...
 */
TxTypeFeeDelegatedValueTransferMemoWithRatio.prototype['feeRatio'] = undefined;
 ...
 */
TxTypeFeeDelegatedValueTransferMemoWithRatio.prototype['signatures'] = undefined;
var _default = exports["default"] = TxTypeFeeDelegatedValueTransferMemoWithRatio;