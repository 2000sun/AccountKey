 ...
 */
/**
 * The TxTypeFeeDelegatedCancel model module.
 * @module model/TxTypeFeeDelegatedCancel
 * @version 0.9.9
 */
var TxTypeFeeDelegatedCancel = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>TxTypeFeeDelegatedCancel</code>.
   * @alias module:model/TxTypeFeeDelegatedCancel
   * @param typeInt {Number} The integer indicating TxTypeFeeDelegatedCancel: 57
   ...
   */
  function TxTypeFeeDelegatedCancel(typeInt, from, feePayer) {
    _classCallCheck(this, TxTypeFeeDelegatedCancel);
    TxTypeFeeDelegatedCancel.initialize(this, typeInt, from, feePayer);
  }
   ...
   */
  _createClass(TxTypeFeeDelegatedCancel, null, [{
    key: "initialize",
    value: function initialize(obj, typeInt, from, feePayer) {
      obj['typeInt'] = typeInt;
      obj['from'] = from;
    ...
    /**
     * Constructs a <code>TxTypeFeeDelegatedCancel</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TxTypeFeeDelegatedCancel} obj Optional instance to populate.
     * @return {module:model/TxTypeFeeDelegatedCancel} The populated <code>TxTypeFeeDelegatedCancel</code> instance.
     */
  }, {
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new TxTypeFeeDelegatedCancel();
    ...
    /**
     * Validates the JSON data with respect to <code>TxTypeFeeDelegatedCancel</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TxTypeFeeDelegatedCancel</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(TxTypeFeeDelegatedCancel.RequiredProperties),
        _step;
      try {
...
TxTypeFeeDelegatedCancel.RequiredProperties = ["typeInt", "from", "feePayer"];

/**
 * The integer indicating TxTypeFeeDelegatedCancel: 57
 * @member {Number} typeInt
 */
TxTypeFeeDelegatedCancel.prototype['typeInt'] = undefined;

/**
 * The address from which the transaction is sent.
 * @member {String} from
 */
TxTypeFeeDelegatedCancel.prototype['from'] = undefined;
 ...
 * @member {String} gas
 */
TxTypeFeeDelegatedCancel.prototype['gas'] = undefined;

/**
 * (optional, default: 25000000000 Peb) Integer of the gasPrice used for each paid gas.
 * @member {String} gasPrice
 */
TxTypeFeeDelegatedCancel.prototype['gasPrice'] = undefined;

/**
 * (optional) Integer of a nonce.
 * @member {String} nonce
 */
TxTypeFeeDelegatedCancel.prototype['nonce'] = undefined;

/**
 * The fee payer address of the transaction.
 * @member {String} feePayer
 */
TxTypeFeeDelegatedCancel.prototype['feePayer'] = undefined;
 ...
 */
TxTypeFeeDelegatedCancel.prototype['signatures'] = undefined;
var _default = exports["default"] = TxTypeFeeDelegatedCancel;