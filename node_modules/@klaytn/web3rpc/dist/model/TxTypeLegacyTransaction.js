 ...
 */
/**
 * The TxTypeLegacyTransaction model module.
 * @module model/TxTypeLegacyTransaction
 * @version 0.9.9
 */
var TxTypeLegacyTransaction = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>TxTypeLegacyTransaction</code>.
   ...
   * @alias module:model/TxTypeLegacyTransaction
   * @param from {String} The address from which the transaction is sent.
   * @param data {String} The compiled byte code of a contract to deploy or data (function indicator and parameter values) required to call a contract.
   */
  function TxTypeLegacyTransaction(from, data) {
    _classCallCheck(this, TxTypeLegacyTransaction);
    TxTypeLegacyTransaction.initialize(this, from, data);
  }
   ...
   */
  _createClass(TxTypeLegacyTransaction, null, [{
    key: "initialize",
    value: function initialize(obj, from, data) {
      obj['from'] = from;
      obj['data'] = data;
    }

    /**
     * Constructs a <code>TxTypeLegacyTransaction</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TxTypeLegacyTransaction} obj Optional instance to populate.
     * @return {module:model/TxTypeLegacyTransaction} The populated <code>TxTypeLegacyTransaction</code> instance.
     */
  }, {
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new TxTypeLegacyTransaction();
    ...
    /**
     * Validates the JSON data with respect to <code>TxTypeLegacyTransaction</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TxTypeLegacyTransaction</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(TxTypeLegacyTransaction.RequiredProperties),
        _step;
      try {
...
TxTypeLegacyTransaction.RequiredProperties = ["from", "data"];

/**
 * The address from which the transaction is sent.
 * @member {String} from
 */
TxTypeLegacyTransaction.prototype['from'] = undefined;

/**
 * (optional when creating a new contract) The address to which the transaction is directed.
 * @member {String} to
 */
TxTypeLegacyTransaction.prototype['to'] = undefined;
 ...
 * @member {String} gas
 */
TxTypeLegacyTransaction.prototype['gas'] = undefined;
 ...
 */
TxTypeLegacyTransaction.prototype['gasPrice'] = undefined;

/**
 * (optional) Integer of the value sent with this transaction.
 * @member {String} value
 */
TxTypeLegacyTransaction.prototype['value'] = undefined;
 ...
 * @member {String} data
 */
TxTypeLegacyTransaction.prototype['data'] = undefined;

/**
 * (optional) Integer of a nonce.
 * @member {String} nonce
 */
TxTypeLegacyTransaction.prototype['nonce'] = undefined;
var _default = exports["default"] = TxTypeLegacyTransaction;