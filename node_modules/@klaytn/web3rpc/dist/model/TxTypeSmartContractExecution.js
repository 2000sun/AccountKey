 ...
 */
/**
 * The TxTypeSmartContractExecution model module.
 * @module model/TxTypeSmartContractExecution
 * @version 0.9.9
 */
var TxTypeSmartContractExecution = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>TxTypeSmartContractExecution</code>.
   * @alias module:model/TxTypeSmartContractExecution
   * @param typeInt {Number} The integer indicating TxTypeSmartContractExecution: 48
   ...
   */
  function TxTypeSmartContractExecution(typeInt, from, to, value, input) {
    _classCallCheck(this, TxTypeSmartContractExecution);
    TxTypeSmartContractExecution.initialize(this, typeInt, from, to, value, input);
  }
   ...
   */
  _createClass(TxTypeSmartContractExecution, null, [{
    key: "initialize",
    value: function initialize(obj, typeInt, from, to, value, input) {
      obj['typeInt'] = typeInt;
      obj['from'] = from;
      obj['to'] = to;
      obj['value'] = value;
    ...
    /**
     * Constructs a <code>TxTypeSmartContractExecution</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TxTypeSmartContractExecution} obj Optional instance to populate.
     * @return {module:model/TxTypeSmartContractExecution} The populated <code>TxTypeSmartContractExecution</code> instance.
     */
  }, {
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new TxTypeSmartContractExecution();
    ...
    /**
     * Validates the JSON data with respect to <code>TxTypeSmartContractExecution</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TxTypeSmartContractExecution</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(TxTypeSmartContractExecution.RequiredProperties),
        _step;
      try {
...
TxTypeSmartContractExecution.RequiredProperties = ["typeInt", "from", "to", "value", "input"];

/**
 * The integer indicating TxTypeSmartContractExecution: 48
 * @member {Number} typeInt
 */
TxTypeSmartContractExecution.prototype['typeInt'] = undefined;

/**
 * The address from which the transaction is sent.
 * @member {String} from
 */
TxTypeSmartContractExecution.prototype['from'] = undefined;

/**
 * The address to which the transaction is directed.
 * @member {String} to
 */
TxTypeSmartContractExecution.prototype['to'] = undefined;
 ...
 * @member {String} gas
 */
TxTypeSmartContractExecution.prototype['gas'] = undefined;

/**
 * (optional, default: 25000000000 Peb) Integer of the gasPrice used for each paid gas.
 * @member {String} gasPrice
 */
TxTypeSmartContractExecution.prototype['gasPrice'] = undefined;

/**
 * (optional) Integer of a nonce.
 * @member {String} nonce
 */
TxTypeSmartContractExecution.prototype['nonce'] = undefined;

/**
 * Integer of the value sent with this transaction.
 * @member {String} value
 */
TxTypeSmartContractExecution.prototype['value'] = undefined;

/**
 * The data sent along with the transaction.
 * @member {String} input
 */
TxTypeSmartContractExecution.prototype['input'] = undefined;
var _default = exports["default"] = TxTypeSmartContractExecution;