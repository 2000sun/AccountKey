 ...
 */
/**
 * The TxTypeSmartContractDeploy model module.
 * @module model/TxTypeSmartContractDeploy
 * @version 0.9.9
 */
var TxTypeSmartContractDeploy = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>TxTypeSmartContractDeploy</code>.
   * @alias module:model/TxTypeSmartContractDeploy
   * @param typeInt {Number} The integer indicating TxTypeSmartContractDeploy: 40
   ...
   */
  function TxTypeSmartContractDeploy(typeInt, from, to, value, input, humanReadable, codeFormat) {
    _classCallCheck(this, TxTypeSmartContractDeploy);
    TxTypeSmartContractDeploy.initialize(this, typeInt, from, to, value, input, humanReadable, codeFormat);
  }
   ...
   */
  _createClass(TxTypeSmartContractDeploy, null, [{
    key: "initialize",
    value: function initialize(obj, typeInt, from, to, value, input, humanReadable, codeFormat) {
      obj['typeInt'] = typeInt;
      obj['from'] = from;
      obj['to'] = to;
      obj['value'] = value;
    ...
    /**
     * Constructs a <code>TxTypeSmartContractDeploy</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TxTypeSmartContractDeploy} obj Optional instance to populate.
     * @return {module:model/TxTypeSmartContractDeploy} The populated <code>TxTypeSmartContractDeploy</code> instance.
     */
  }, {
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new TxTypeSmartContractDeploy();
    ...
    /**
     * Validates the JSON data with respect to <code>TxTypeSmartContractDeploy</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TxTypeSmartContractDeploy</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(TxTypeSmartContractDeploy.RequiredProperties),
        _step;
      try {
...
TxTypeSmartContractDeploy.RequiredProperties = ["typeInt", "from", "to", "value", "input", "humanReadable", "codeFormat"];

/**
 * The integer indicating TxTypeSmartContractDeploy: 40
 * @member {Number} typeInt
 */
TxTypeSmartContractDeploy.prototype['typeInt'] = undefined;

/**
 * The address from which the transaction is sent.
 * @member {String} from
 */
TxTypeSmartContractDeploy.prototype['from'] = undefined;

/**
 * The address to which the transaction is directed.
 * @member {String} to
 */
TxTypeSmartContractDeploy.prototype['to'] = undefined;
 ...
 * @member {String} gas
 */
TxTypeSmartContractDeploy.prototype['gas'] = undefined;

/**
 * (optional, default: 25000000000 Peb) Integer of the gasPrice used for each paid gas.
 * @member {String} gasPrice
 */
TxTypeSmartContractDeploy.prototype['gasPrice'] = undefined;

/**
 * (optional) Integer of a nonce.
 * @member {String} nonce
 */
TxTypeSmartContractDeploy.prototype['nonce'] = undefined;

/**
 * Integer of the value sent with this transaction.
 * @member {String} value
 */
TxTypeSmartContractDeploy.prototype['value'] = undefined;

/**
 * The data sent along with the transaction.
 * @member {String} input
 */
TxTypeSmartContractDeploy.prototype['input'] = undefined;
 ...
 */
TxTypeSmartContractDeploy.prototype['humanReadable'] = undefined;

/**
 * The code format of smart contract code. The value 0 indicates EVM.
 * @member {String} codeFormat
 */
TxTypeSmartContractDeploy.prototype['codeFormat'] = undefined;
var _default = exports["default"] = TxTypeSmartContractDeploy;