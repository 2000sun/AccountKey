 ...
 */
/**
 * The TxTypeFeeDelegatedAccountUpdateWithRatio model module.
 * @module model/TxTypeFeeDelegatedAccountUpdateWithRatio
 * @version 0.9.9
 */
var TxTypeFeeDelegatedAccountUpdateWithRatio = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>TxTypeFeeDelegatedAccountUpdateWithRatio</code>.
   * @alias module:model/TxTypeFeeDelegatedAccountUpdateWithRatio
   * @param typeInt {Number} The integer indicating TxTypeFeeDelegatedAccountUpdateWithRatio: 34
   * @param from {String} The address from which the transaction is sent.
   * @param key {String} The new account key of the from account in RLP encoded format. For more information about the account key, see Account Key.
   ...
   */
  function TxTypeFeeDelegatedAccountUpdateWithRatio(typeInt, from, key, feePayer, feeRatio) {
    _classCallCheck(this, TxTypeFeeDelegatedAccountUpdateWithRatio);
    TxTypeFeeDelegatedAccountUpdateWithRatio.initialize(this, typeInt, from, key, feePayer, feeRatio);
  }
   ...
   */
  _createClass(TxTypeFeeDelegatedAccountUpdateWithRatio, null, [{
    key: "initialize",
    value: function initialize(obj, typeInt, from, key, feePayer, feeRatio) {
      obj['typeInt'] = typeInt;
      obj['from'] = from;
      obj['key'] = key;
    ...
    /**
     * Constructs a <code>TxTypeFeeDelegatedAccountUpdateWithRatio</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TxTypeFeeDelegatedAccountUpdateWithRatio} obj Optional instance to populate.
     * @return {module:model/TxTypeFeeDelegatedAccountUpdateWithRatio} The populated <code>TxTypeFeeDelegatedAccountUpdateWithRatio</code> instance.
     */
  }, {
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new TxTypeFeeDelegatedAccountUpdateWithRatio();
    ...
    /**
     * Validates the JSON data with respect to <code>TxTypeFeeDelegatedAccountUpdateWithRatio</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TxTypeFeeDelegatedAccountUpdateWithRatio</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(TxTypeFeeDelegatedAccountUpdateWithRatio.RequiredProperties),
        _step;
      try {
...
TxTypeFeeDelegatedAccountUpdateWithRatio.RequiredProperties = ["typeInt", "from", "key", "feePayer", "feeRatio"];

/**
 * The integer indicating TxTypeFeeDelegatedAccountUpdateWithRatio: 34
 * @member {Number} typeInt
 */
TxTypeFeeDelegatedAccountUpdateWithRatio.prototype['typeInt'] = undefined;

/**
 * The address from which the transaction is sent.
 * @member {String} from
 */
TxTypeFeeDelegatedAccountUpdateWithRatio.prototype['from'] = undefined;
 ...
 * @member {String} gas
 */
TxTypeFeeDelegatedAccountUpdateWithRatio.prototype['gas'] = undefined;

/**
 * (optional, default: 25000000000 Peb) Integer of the gasPrice used for each paid gas.
 * @member {String} gasPrice
 */
TxTypeFeeDelegatedAccountUpdateWithRatio.prototype['gasPrice'] = undefined;

/**
 * (optional) Integer of a nonce.
 * @member {String} nonce
 */
TxTypeFeeDelegatedAccountUpdateWithRatio.prototype['nonce'] = undefined;

/**
 * The new account key of the from account in RLP encoded format. For more information about the account key, see Account Key.
 * @member {String} key
 */
TxTypeFeeDelegatedAccountUpdateWithRatio.prototype['key'] = undefined;

/**
 * The fee payer address of the transaction.
 * @member {String} feePayer
 */
TxTypeFeeDelegatedAccountUpdateWithRatio.prototype['feePayer'] = undefined;
 ...
 */
TxTypeFeeDelegatedAccountUpdateWithRatio.prototype['feeRatio'] = undefined;
 ...
 */
TxTypeFeeDelegatedAccountUpdateWithRatio.prototype['signatures'] = undefined;
var _default = exports["default"] = TxTypeFeeDelegatedAccountUpdateWithRatio;