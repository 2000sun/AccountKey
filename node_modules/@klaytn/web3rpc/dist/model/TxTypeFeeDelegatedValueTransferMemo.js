 ...
 */
/**
 * The TxTypeFeeDelegatedValueTransferMemo model module.
 * @module model/TxTypeFeeDelegatedValueTransferMemo
 * @version 0.9.9
 */
var TxTypeFeeDelegatedValueTransferMemo = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>TxTypeFeeDelegatedValueTransferMemo</code>.
   * Fee delegating version of TxTypeValueTransferMemo. For more information, see TxTypeFeeDelegatedValueTransferMemo.
   * @alias module:model/TxTypeFeeDelegatedValueTransferMemo
   * @param typeInt {Number} The integer indicating TxTypeFeeDelegatedValueTransferMemo 17
   ...
   */
  function TxTypeFeeDelegatedValueTransferMemo(typeInt, from, to, value, input, feePayer) {
    _classCallCheck(this, TxTypeFeeDelegatedValueTransferMemo);
    TxTypeFeeDelegatedValueTransferMemo.initialize(this, typeInt, from, to, value, input, feePayer);
  }
   ...
   */
  _createClass(TxTypeFeeDelegatedValueTransferMemo, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>TxTypeFeeDelegatedValueTransferMemo</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TxTypeFeeDelegatedValueTransferMemo} obj Optional instance to populate.
     * @return {module:model/TxTypeFeeDelegatedValueTransferMemo} The populated <code>TxTypeFeeDelegatedValueTransferMemo</code> instance.
     */
  }, {
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new TxTypeFeeDelegatedValueTransferMemo();
    ...
    /**
     * Validates the JSON data with respect to <code>TxTypeFeeDelegatedValueTransferMemo</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TxTypeFeeDelegatedValueTransferMemo</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(TxTypeFeeDelegatedValueTransferMemo.RequiredProperties),
        _step;
      try {
...
TxTypeFeeDelegatedValueTransferMemo.RequiredProperties = ["typeInt", "from", "to", "value", "input", "feePayer"];

/**
 * The integer indicating TxTypeFeeDelegatedValueTransferMemo 17
 * @member {Number} typeInt
 */
TxTypeFeeDelegatedValueTransferMemo.prototype['typeInt'] = undefined;

/**
 * The address from which the transaction is sent.
 * @member {String} from
 */
TxTypeFeeDelegatedValueTransferMemo.prototype['from'] = undefined;

/**
 * The address to which the transaction is directed.
 * @member {String} to
 */
TxTypeFeeDelegatedValueTransferMemo.prototype['to'] = undefined;
 ...
 * @member {String} gas
 */
TxTypeFeeDelegatedValueTransferMemo.prototype['gas'] = undefined;

/**
 * (optional, default 25000000000 Peb) Integer of the gasPrice used for each paid gas.
 * @member {String} gasPrice
 */
TxTypeFeeDelegatedValueTransferMemo.prototype['gasPrice'] = undefined;

/**
 * (optional) Integer of a nonce.
 * @member {String} nonce
 */
TxTypeFeeDelegatedValueTransferMemo.prototype['nonce'] = undefined;

/**
 * Integer of the value sent with this transaction.
 * @member {String} value
 */
TxTypeFeeDelegatedValueTransferMemo.prototype['value'] = undefined;

/**
 * The data sent along with the transaction.
 * @member {String} input
 */
TxTypeFeeDelegatedValueTransferMemo.prototype['input'] = undefined;

/**
 * The fee payer address of the transaction.
 * @member {String} feePayer
 */
TxTypeFeeDelegatedValueTransferMemo.prototype['feePayer'] = undefined;
 ...
 */
TxTypeFeeDelegatedValueTransferMemo.prototype['signatures'] = undefined;
var _default = exports["default"] = TxTypeFeeDelegatedValueTransferMemo;