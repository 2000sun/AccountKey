...
var _SendArgsAccessListInner = _interopRequireDefault(require("./SendArgsAccessListInner"));
 ...
 */
/**
 * The SendArgs model module.
 * @module model/SendArgs
 * @version 0.9.9
 */
var SendArgs = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>SendArgs</code>.
   * @alias module:model/SendArgs
   * @param nonce {String} 
   * @param to {String} 
   */
  function SendArgs(nonce, to) {
    _classCallCheck(this, SendArgs);
    SendArgs.initialize(this, nonce, to);
  }
   ...
   */
  _createClass(SendArgs, null, [{
    key: "initialize",
    value: function initialize(obj, nonce, to) {
      obj['nonce'] = nonce;
      obj['to'] = to;
    }

    /**
     * Constructs a <code>SendArgs</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SendArgs} obj Optional instance to populate.
     * @return {module:model/SendArgs} The populated <code>SendArgs</code> instance.
     */
  }, {
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new SendArgs();
        if (data.hasOwnProperty('accessList')) {
          obj['accessList'] = _ApiClient["default"].convertToType(data['accessList'], [_SendArgsAccessListInner["default"]]);
        }
    ...
    /**
     * Validates the JSON data with respect to <code>SendArgs</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SendArgs</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(SendArgs.RequiredProperties),
        _step;
      try {
      ...
      if (data['accessList']) {
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            _SendArgsAccessListInner["default"].validateJsonObject(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
...
SendArgs.RequiredProperties = ["nonce", "to"];

/**
 * @member {Array.<module:model/SendArgsAccessListInner>} accessList
 */
SendArgs.prototype['accessList'] = undefined;

/**
 * @member {String} chainId
 */
SendArgs.prototype['chainId'] = undefined;

/**
 * @member {String} data
 */
SendArgs.prototype['data'] = undefined;

/**
 * @member {String} from
 */
SendArgs.prototype['from'] = undefined;

/**
 * @member {String} gas
 */
SendArgs.prototype['gas'] = undefined;

/**
 * @member {String} gasPrice
 */
SendArgs.prototype['gasPrice'] = undefined;

/**
 * @member {String} input
 */
SendArgs.prototype['input'] = undefined;

/**
 * @member {String} maxFeePerGas
 */
SendArgs.prototype['maxFeePerGas'] = undefined;

/**
 * @member {String} maxPriorityFeePerGas
 */
SendArgs.prototype['maxPriorityFeePerGas'] = undefined;

/**
 * @member {String} nonce
 */
SendArgs.prototype['nonce'] = undefined;

/**
 * @member {String} to
 */
SendArgs.prototype['to'] = undefined;

/**
 * @member {String} value
 */
SendArgs.prototype['value'] = undefined;
var _default = exports["default"] = SendArgs;