 ...
 */
/**
 * The TxTypeFeeDelegatedValueTransfer model module.
 * @module model/TxTypeFeeDelegatedValueTransfer
 * @version 0.9.9
 */
var TxTypeFeeDelegatedValueTransfer = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>TxTypeFeeDelegatedValueTransfer</code>.
   * Fee delegating version of TxTypeValueTransfer. For more information, see TxTypeFeeDelegatedValueTransfer.
   * @alias module:model/TxTypeFeeDelegatedValueTransfer
   * @param typeInt {Number} The integer indicating TxTypeFeeDelegatedValueTransfer 9
   ...
   * @param feePayer {String} The address which pays the transaction fee.
   */
  function TxTypeFeeDelegatedValueTransfer(typeInt, from, to, value, feePayer) {
    _classCallCheck(this, TxTypeFeeDelegatedValueTransfer);
    TxTypeFeeDelegatedValueTransfer.initialize(this, typeInt, from, to, value, feePayer);
  }
   ...
   */
  _createClass(TxTypeFeeDelegatedValueTransfer, null, [{
    key: "initialize",
    value: function initialize(obj, typeInt, from, to, value, feePayer) {
      obj['typeInt'] = typeInt;
      obj['from'] = from;
      obj['to'] = to;
      obj['value'] = value;
    ...
    /**
     * Constructs a <code>TxTypeFeeDelegatedValueTransfer</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TxTypeFeeDelegatedValueTransfer} obj Optional instance to populate.
     * @return {module:model/TxTypeFeeDelegatedValueTransfer} The populated <code>TxTypeFeeDelegatedValueTransfer</code> instance.
     */
  }, {
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new TxTypeFeeDelegatedValueTransfer();
    ...
    /**
     * Validates the JSON data with respect to <code>TxTypeFeeDelegatedValueTransfer</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TxTypeFeeDelegatedValueTransfer</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(TxTypeFeeDelegatedValueTransfer.RequiredProperties),
        _step;
      try {
...
TxTypeFeeDelegatedValueTransfer.RequiredProperties = ["typeInt", "from", "to", "value", "feePayer"];

/**
 * The integer indicating TxTypeFeeDelegatedValueTransfer 9
 * @member {Number} typeInt
 */
TxTypeFeeDelegatedValueTransfer.prototype['typeInt'] = undefined;

/**
 * The address from which the transaction is sent.
 * @member {String} from
 */
TxTypeFeeDelegatedValueTransfer.prototype['from'] = undefined;

/**
 * The address to which the transaction is directed.
 * @member {String} to
 */
TxTypeFeeDelegatedValueTransfer.prototype['to'] = undefined;
 ...
 * @member {String} gas
 */
TxTypeFeeDelegatedValueTransfer.prototype['gas'] = undefined;
 ...
 */
TxTypeFeeDelegatedValueTransfer.prototype['gasPrice'] = undefined;

/**
 * (optional) Integer of a nonce.
 * @member {String} nonce
 */
TxTypeFeeDelegatedValueTransfer.prototype['nonce'] = undefined;

/**
 * Integer of the value sent with this transaction.
 * @member {String} value
 */
TxTypeFeeDelegatedValueTransfer.prototype['value'] = undefined;

/**
 * The address which pays the transaction fee.
 * @member {String} feePayer
 */
TxTypeFeeDelegatedValueTransfer.prototype['feePayer'] = undefined;
 ...
 */
TxTypeFeeDelegatedValueTransfer.prototype['signatures'] = undefined;
var _default = exports["default"] = TxTypeFeeDelegatedValueTransfer;