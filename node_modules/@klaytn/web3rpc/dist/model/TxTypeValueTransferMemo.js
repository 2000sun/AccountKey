 ...
 */
/**
 * The TxTypeValueTransferMemo model module.
 * @module model/TxTypeValueTransferMemo
 * @version 0.9.9
 */
var TxTypeValueTransferMemo = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>TxTypeValueTransferMemo</code>.
   ...
   * @alias module:model/TxTypeValueTransferMemo
   * @param typeInt {Number} The integer indicating TxTypeValueTransferMemo 16
   ...
   */
  function TxTypeValueTransferMemo(typeInt, from, to, value, input) {
    _classCallCheck(this, TxTypeValueTransferMemo);
    TxTypeValueTransferMemo.initialize(this, typeInt, from, to, value, input);
  }
   ...
   */
  _createClass(TxTypeValueTransferMemo, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>TxTypeValueTransferMemo</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TxTypeValueTransferMemo} obj Optional instance to populate.
     * @return {module:model/TxTypeValueTransferMemo} The populated <code>TxTypeValueTransferMemo</code> instance.
     */
  }, {
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new TxTypeValueTransferMemo();
    ...
    /**
     * Validates the JSON data with respect to <code>TxTypeValueTransferMemo</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TxTypeValueTransferMemo</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(TxTypeValueTransferMemo.RequiredProperties),
        _step;
      try {
...
TxTypeValueTransferMemo.RequiredProperties = ["typeInt", "from", "to", "value", "input"];

/**
 * The integer indicating TxTypeValueTransferMemo 16
 * @member {Number} typeInt
 */
TxTypeValueTransferMemo.prototype['typeInt'] = undefined;

/**
 * The address from which the transaction is sent.
 * @member {String} from
 */
TxTypeValueTransferMemo.prototype['from'] = undefined;

/**
 * The address to which the transaction is directed.
 * @member {String} to
 */
TxTypeValueTransferMemo.prototype['to'] = undefined;
 ...
 * @member {String} gas
 */
TxTypeValueTransferMemo.prototype['gas'] = undefined;
 ...
 */
TxTypeValueTransferMemo.prototype['gasPrice'] = undefined;

/**
 * (optional) Integer of a nonce.
 * @member {String} nonce
 */
TxTypeValueTransferMemo.prototype['nonce'] = undefined;

/**
 * Integer of the value sent with this transaction.
 * @member {String} value
 */
TxTypeValueTransferMemo.prototype['value'] = undefined;

/**
 * The data sent along with the transaction.
 * @member {String} input
 */
TxTypeValueTransferMemo.prototype['input'] = undefined;
var _default = exports["default"] = TxTypeValueTransferMemo;