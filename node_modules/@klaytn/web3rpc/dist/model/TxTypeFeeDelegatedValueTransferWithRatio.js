 ...
 */
/**
 * The TxTypeFeeDelegatedValueTransferWithRatio model module.
 * @module model/TxTypeFeeDelegatedValueTransferWithRatio
 * @version 0.9.9
 */
var TxTypeFeeDelegatedValueTransferWithRatio = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>TxTypeFeeDelegatedValueTransferWithRatio</code>.
   * Partial fee delegating version of TxTypeValueTransfer. For more information, see TxTypeFeeDelegatedValueTransferWithRatio.
   * @alias module:model/TxTypeFeeDelegatedValueTransferWithRatio
   * @param typeInt {Number} The integer indicating TxTypeFeeDelegatedValueTransferWithRatio 10
   ...
   * @param feeRatio {Number} Fee ratio of the fee payer. If it is 30, 30% of the fee will be paid by the fee payer. 70% will be paid by the sender. The range of fee ratio is 1 ~ 99, if it is out of range, the transaction will not be accepted.
   */
  function TxTypeFeeDelegatedValueTransferWithRatio(typeInt, from, to, value, feePayer, feeRatio) {
    _classCallCheck(this, TxTypeFeeDelegatedValueTransferWithRatio);
    TxTypeFeeDelegatedValueTransferWithRatio.initialize(this, typeInt, from, to, value, feePayer, feeRatio);
  }
   ...
   */
  _createClass(TxTypeFeeDelegatedValueTransferWithRatio, null, [{
    key: "initialize",
    value: function initialize(obj, typeInt, from, to, value, feePayer, feeRatio) {
      obj['typeInt'] = typeInt;
      obj['from'] = from;
      obj['to'] = to;
      obj['value'] = value;
    ...
    /**
     * Constructs a <code>TxTypeFeeDelegatedValueTransferWithRatio</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TxTypeFeeDelegatedValueTransferWithRatio} obj Optional instance to populate.
     * @return {module:model/TxTypeFeeDelegatedValueTransferWithRatio} The populated <code>TxTypeFeeDelegatedValueTransferWithRatio</code> instance.
     */
  }, {
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new TxTypeFeeDelegatedValueTransferWithRatio();
        ...
        if (data.hasOwnProperty('feeRatio')) {
          obj['feeRatio'] = _ApiClient["default"].convertToType(data['feeRatio'], 'Number');
        }
    ...
    /**
     * Validates the JSON data with respect to <code>TxTypeFeeDelegatedValueTransferWithRatio</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TxTypeFeeDelegatedValueTransferWithRatio</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(TxTypeFeeDelegatedValueTransferWithRatio.RequiredProperties),
        _step;
      try {
...
TxTypeFeeDelegatedValueTransferWithRatio.RequiredProperties = ["typeInt", "from", "to", "value", "feePayer", "feeRatio"];

/**
 * The integer indicating TxTypeFeeDelegatedValueTransferWithRatio 10
 * @member {Number} typeInt
 */
TxTypeFeeDelegatedValueTransferWithRatio.prototype['typeInt'] = undefined;

/**
 * The address from which the transaction is sent.
 * @member {String} from
 */
TxTypeFeeDelegatedValueTransferWithRatio.prototype['from'] = undefined;

/**
 * The address to which the transaction is directed.
 * @member {String} to
 */
TxTypeFeeDelegatedValueTransferWithRatio.prototype['to'] = undefined;
 ...
 * @member {String} gas
 */
TxTypeFeeDelegatedValueTransferWithRatio.prototype['gas'] = undefined;

/**
 * (optional, default 25000000000 Peb) Integer of the gasPrice used for each paid gas.
 * @member {String} gasPrice
 */
TxTypeFeeDelegatedValueTransferWithRatio.prototype['gasPrice'] = undefined;

/**
 * (optional) Integer of a nonce.
 * @member {String} nonce
 */
TxTypeFeeDelegatedValueTransferWithRatio.prototype['nonce'] = undefined;

/**
 * Integer of the value sent with this transaction.
 * @member {String} value
 */
TxTypeFeeDelegatedValueTransferWithRatio.prototype['value'] = undefined;

/**
 * The fee payer address of the transaction.
 * @member {String} feePayer
 */
TxTypeFeeDelegatedValueTransferWithRatio.prototype['feePayer'] = undefined;
 ...
 */
TxTypeFeeDelegatedValueTransferWithRatio.prototype['feeRatio'] = undefined;
 ...
 */
TxTypeFeeDelegatedValueTransferWithRatio.prototype['signatures'] = undefined;
var _default = exports["default"] = TxTypeFeeDelegatedValueTransferWithRatio;