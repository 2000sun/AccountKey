 ...
 */
/**
 * The TxTypeCancel model module.
 * @module model/TxTypeCancel
 * @version 0.9.9
 */
var TxTypeCancel = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>TxTypeCancel</code>.
   * @alias module:model/TxTypeCancel
   * @param typeInt {Number} The integer indicating TxTypeCancel: 56
   * @param from {String} The address from which the transaction is sent.
   */
  function TxTypeCancel(typeInt, from) {
    _classCallCheck(this, TxTypeCancel);
    TxTypeCancel.initialize(this, typeInt, from);
  }
   ...
   */
  _createClass(TxTypeCancel, null, [{
    key: "initialize",
    value: function initialize(obj, typeInt, from) {
      obj['typeInt'] = typeInt;
      obj['from'] = from;
    }

    /**
     * Constructs a <code>TxTypeCancel</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TxTypeCancel} obj Optional instance to populate.
     * @return {module:model/TxTypeCancel} The populated <code>TxTypeCancel</code> instance.
     */
  }, {
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new TxTypeCancel();
    ...
    /**
     * Validates the JSON data with respect to <code>TxTypeCancel</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TxTypeCancel</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(TxTypeCancel.RequiredProperties),
        _step;
      try {
...
TxTypeCancel.RequiredProperties = ["typeInt", "from"];

/**
 * The integer indicating TxTypeCancel: 56
 * @member {Number} typeInt
 */
TxTypeCancel.prototype['typeInt'] = undefined;

/**
 * The address from which the transaction is sent.
 * @member {String} from
 */
TxTypeCancel.prototype['from'] = undefined;
 ...
 * @member {String} gas
 */
TxTypeCancel.prototype['gas'] = undefined;

/**
 * (optional, default: 25000000000 Peb) Integer of the gasPrice used for each paid gas.
 * @member {String} gasPrice
 */
TxTypeCancel.prototype['gasPrice'] = undefined;

/**
 * (optional) Integer of a nonce.
 * @member {String} nonce
 */
TxTypeCancel.prototype['nonce'] = undefined;
var _default = exports["default"] = TxTypeCancel;