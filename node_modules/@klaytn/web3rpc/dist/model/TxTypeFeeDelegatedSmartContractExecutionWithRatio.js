 ...
 */
/**
 * The TxTypeFeeDelegatedSmartContractExecutionWithRatio model module.
 * @module model/TxTypeFeeDelegatedSmartContractExecutionWithRatio
 * @version 0.9.9
 */
var TxTypeFeeDelegatedSmartContractExecutionWithRatio = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>TxTypeFeeDelegatedSmartContractExecutionWithRatio</code>.
   * @alias module:model/TxTypeFeeDelegatedSmartContractExecutionWithRatio
   * @param typeInt {Number} The integer indicating TxTypeFeeDelegatedSmartContractExecutionWithRatio: 50
   ...
   */
  function TxTypeFeeDelegatedSmartContractExecutionWithRatio(typeInt, from, to, value, input, feePayer, feeRatio) {
    _classCallCheck(this, TxTypeFeeDelegatedSmartContractExecutionWithRatio);
    TxTypeFeeDelegatedSmartContractExecutionWithRatio.initialize(this, typeInt, from, to, value, input, feePayer, feeRatio);
  }
   ...
   */
  _createClass(TxTypeFeeDelegatedSmartContractExecutionWithRatio, null, [{
    key: "initialize",
    value: function initialize(obj, typeInt, from, to, value, input, feePayer, feeRatio) {
      obj['typeInt'] = typeInt;
      obj['from'] = from;
      obj['to'] = to;
      obj['value'] = value;
    ...
    /**
     * Constructs a <code>TxTypeFeeDelegatedSmartContractExecutionWithRatio</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TxTypeFeeDelegatedSmartContractExecutionWithRatio} obj Optional instance to populate.
     * @return {module:model/TxTypeFeeDelegatedSmartContractExecutionWithRatio} The populated <code>TxTypeFeeDelegatedSmartContractExecutionWithRatio</code> instance.
     */
  }, {
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new TxTypeFeeDelegatedSmartContractExecutionWithRatio();
    ...
    /**
     * Validates the JSON data with respect to <code>TxTypeFeeDelegatedSmartContractExecutionWithRatio</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TxTypeFeeDelegatedSmartContractExecutionWithRatio</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(TxTypeFeeDelegatedSmartContractExecutionWithRatio.RequiredProperties),
        _step;
      try {
...
TxTypeFeeDelegatedSmartContractExecutionWithRatio.RequiredProperties = ["typeInt", "from", "to", "value", "input", "feePayer", "feeRatio"];

/**
 * The integer indicating TxTypeFeeDelegatedSmartContractExecutionWithRatio: 50
 * @member {Number} typeInt
 */
TxTypeFeeDelegatedSmartContractExecutionWithRatio.prototype['typeInt'] = undefined;

/**
 * The address from which the transaction is sent.
 * @member {String} from
 */
TxTypeFeeDelegatedSmartContractExecutionWithRatio.prototype['from'] = undefined;

/**
 * The address to which the transaction is directed.
 * @member {String} to
 */
TxTypeFeeDelegatedSmartContractExecutionWithRatio.prototype['to'] = undefined;
 ...
 * @member {String} gas
 */
TxTypeFeeDelegatedSmartContractExecutionWithRatio.prototype['gas'] = undefined;

/**
 * (optional, default: 25000000000 Peb) Integer of the gasPrice used for each paid gas.
 * @member {String} gasPrice
 */
TxTypeFeeDelegatedSmartContractExecutionWithRatio.prototype['gasPrice'] = undefined;

/**
 * (optional) Integer of a nonce.
 * @member {String} nonce
 */
TxTypeFeeDelegatedSmartContractExecutionWithRatio.prototype['nonce'] = undefined;

/**
 * Integer of the value sent with this transaction.
 * @member {String} value
 */
TxTypeFeeDelegatedSmartContractExecutionWithRatio.prototype['value'] = undefined;

/**
 * The data sent along with the transaction.
 * @member {String} input
 */
TxTypeFeeDelegatedSmartContractExecutionWithRatio.prototype['input'] = undefined;

/**
 * The fee payer address of the transaction.
 * @member {String} feePayer
 */
TxTypeFeeDelegatedSmartContractExecutionWithRatio.prototype['feePayer'] = undefined;
 ...
 */
TxTypeFeeDelegatedSmartContractExecutionWithRatio.prototype['feeRatio'] = undefined;
 ...
 */
TxTypeFeeDelegatedSmartContractExecutionWithRatio.prototype['signatures'] = undefined;
var _default = exports["default"] = TxTypeFeeDelegatedSmartContractExecutionWithRatio;