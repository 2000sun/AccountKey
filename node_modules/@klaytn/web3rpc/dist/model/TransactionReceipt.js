...
var _KlayArrayOfLogInner = _interopRequireDefault(require("./KlayArrayOfLogInner"));
var _TransactionReceiptFeePayerSignaturesInner = _interopRequireDefault(require("./TransactionReceiptFeePayerSignaturesInner"));
...
var TransactionReceipt = /*#__PURE__*/function () {
   ...
   * @param effectiveGasPrice {String} The actual value per gas deducted from the senders account.
   ...
   * @param logs {Array.<module:model/KlayArrayOfLogInner>} Array of log objects, or an empty array if nothing has changed since last poll.
   ...
   * @param signature {Array.<module:model/TransactionReceiptFeePayerSignaturesInner>} (optional) An array of fee payer's signature objects. A signature object contains three fields (V, R, and S). V contains ECDSA recovery id. R contains ECDSA signature r while S contains ECDSA signature s.
   ...
   * @param typeInt {String} An integer representing the type of the transaction.
   * @param value {String} Value transferred in peb.
   */
  function TransactionReceipt(blockHash, blockNumber, contractAddress, from, gas, effectiveGasPrice, gasPrice, gasUsed, logs, logsBloom, nonce, senderTxHash, signature, status, to, transactionHash, transactionIndex, type, typeInt, value) {
    _classCallCheck(this, TransactionReceipt);
    TransactionReceipt.initialize(this, blockHash, blockNumber, contractAddress, from, gas, effectiveGasPrice, gasPrice, gasUsed, logs, logsBloom, nonce, senderTxHash, signature, status, to, transactionHash, transactionIndex, type, typeInt, value);
  }
   ...
   */
  _createClass(TransactionReceipt, null, [{
    key: "initialize",
    value: function initialize(obj, blockHash, blockNumber, contractAddress, from, gas, effectiveGasPrice, gasPrice, gasUsed, logs, logsBloom, nonce, senderTxHash, signature, status, to, transactionHash, transactionIndex, type, typeInt, value) {
      obj['blockHash'] = blockHash;
      obj['blockNumber'] = blockNumber;
      obj['contractAddress'] = contractAddress;
      obj['from'] = from;
      obj['gas'] = gas;
      obj['effectiveGasPrice'] = effectiveGasPrice;
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('feePayerSignatures')) {
          obj['feePayerSignatures'] = _ApiClient["default"].convertToType(data['feePayerSignatures'], [_TransactionReceiptFeePayerSignaturesInner["default"]]);
        }
        ...
        if (data.hasOwnProperty('effectiveGasPrice')) {
          obj['effectiveGasPrice'] = _ApiClient["default"].convertToType(data['effectiveGasPrice'], 'String');
        }
        ...
        if (data.hasOwnProperty('logs')) {
          obj['logs'] = _ApiClient["default"].convertToType(data['logs'], [_KlayArrayOfLogInner["default"]]);
        }
        ...
        if (data.hasOwnProperty('signature')) {
          obj['signature'] = _ApiClient["default"].convertToType(data['signature'], [_TransactionReceiptFeePayerSignaturesInner["default"]]);
        }
        ...
        if (data.hasOwnProperty('typeInt')) {
          obj['typeInt'] = _ApiClient["default"].convertToType(data['typeInt'], 'String');
        }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(TransactionReceipt.RequiredProperties),
        _step;
      try {
      ...
      if (data['feePayerSignatures']) {
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            _TransactionReceiptFeePayerSignaturesInner["default"].validateJsonObject(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
      ...
      if (data['logs']) {
        ...
        var _iterator3 = _createForOfIteratorHelper(data['logs']),
          _step3;
        try {
          for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
            var _item = _step3.value;
            _KlayArrayOfLogInner["default"].validateJsonObject(_item);
          }
        } catch (err) {
          _iterator3.e(err);
        } finally {
      ...
      if (data['signature']) {
        ...
        var _iterator4 = _createForOfIteratorHelper(data['signature']),
          _step4;
        try {
          for (_iterator4.s(); !(_step4 = _iterator4.n()).done;) {
            var _item2 = _step4.value;
            _TransactionReceiptFeePayerSignaturesInner["default"].validateJsonObject(_item2);
          }
        } catch (err) {
          _iterator4.e(err);
        } finally {
      ...
      // ensure the json data is a string
      if (data['typeInt'] && !(typeof data['typeInt'] === 'string' || data['typeInt'] instanceof String)) {
        throw new Error("Expected the field `typeInt` to be a primitive type in the JSON string but got " + data['typeInt']);
      }
      // ensure the json data is a string
...
TransactionReceipt.RequiredProperties = ["blockHash", "blockNumber", "contractAddress", "from", "gas", "effectiveGasPrice", "gasPrice", "gasUsed", "logs", "logsBloom", "nonce", "senderTxHash", "signature", "status", "to", "transactionHash", "transactionIndex", "type", "typeInt", "value"];
 ...
 * @member {Array.<module:model/TransactionReceiptFeePayerSignaturesInner>} feePayerSignatures
 */
 ...
 */
TransactionReceipt.prototype['feeRatio'] = undefined;
 ...
 * @member {String} key
 */
TransactionReceipt.prototype['key'] = undefined;
 ...
 * @member {Array.<module:model/KlayArrayOfLogInner>} logs
 */
...
/**
 * (optional) An array of fee payer's signature objects. A signature object contains three fields (V, R, and S). V contains ECDSA recovery id. R contains ECDSA signature r while S contains ECDSA signature s.
 * @member {Array.<module:model/TransactionReceiptFeePayerSignaturesInner>} signature
 */
TransactionReceipt.prototype['signature'] = undefined;
 ...
 */
TransactionReceipt.prototype['txError'] = undefined;
...
var _default = exports["default"] = TransactionReceipt;