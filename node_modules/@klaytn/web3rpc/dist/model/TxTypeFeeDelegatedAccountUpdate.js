 ...
 */
/**
 * The TxTypeFeeDelegatedAccountUpdate model module.
 * @module model/TxTypeFeeDelegatedAccountUpdate
 * @version 0.9.9
 */
var TxTypeFeeDelegatedAccountUpdate = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>TxTypeFeeDelegatedAccountUpdate</code>.
   * Fee delegating version of TxTypeAccountUpdate. For more information, see TxTypeFeeDelegatedAccountUpdate.
   * @alias module:model/TxTypeFeeDelegatedAccountUpdate
   * @param typeInt {Number} The integer indicating TxTypeFeeDelegatedAccountUpdate 33
   ...
   */
  function TxTypeFeeDelegatedAccountUpdate(typeInt, from, key, feePayer) {
    _classCallCheck(this, TxTypeFeeDelegatedAccountUpdate);
    TxTypeFeeDelegatedAccountUpdate.initialize(this, typeInt, from, key, feePayer);
  }
   ...
   */
  _createClass(TxTypeFeeDelegatedAccountUpdate, null, [{
    key: "initialize",
    value: function initialize(obj, typeInt, from, key, feePayer) {
      obj['typeInt'] = typeInt;
      obj['from'] = from;
      obj['key'] = key;
    ...
    /**
     * Constructs a <code>TxTypeFeeDelegatedAccountUpdate</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TxTypeFeeDelegatedAccountUpdate} obj Optional instance to populate.
     * @return {module:model/TxTypeFeeDelegatedAccountUpdate} The populated <code>TxTypeFeeDelegatedAccountUpdate</code> instance.
     */
  }, {
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new TxTypeFeeDelegatedAccountUpdate();
    ...
    /**
     * Validates the JSON data with respect to <code>TxTypeFeeDelegatedAccountUpdate</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TxTypeFeeDelegatedAccountUpdate</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(TxTypeFeeDelegatedAccountUpdate.RequiredProperties),
        _step;
      try {
...
TxTypeFeeDelegatedAccountUpdate.RequiredProperties = ["typeInt", "from", "key", "feePayer"];

/**
 * The integer indicating TxTypeFeeDelegatedAccountUpdate 33
 * @member {Number} typeInt
 */
TxTypeFeeDelegatedAccountUpdate.prototype['typeInt'] = undefined;

/**
 * The address from which the transaction is sent.
 * @member {String} from
 */
TxTypeFeeDelegatedAccountUpdate.prototype['from'] = undefined;
 ...
 */
TxTypeFeeDelegatedAccountUpdate.prototype['signatures'] = undefined;
var _default = exports["default"] = TxTypeFeeDelegatedAccountUpdate;