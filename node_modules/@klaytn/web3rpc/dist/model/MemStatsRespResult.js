...
var MemStatsRespResult = /*#__PURE__*/function () {
   ...
   * @param nextGC {String} NextGC is the target heap size of the next GC cycle. The garbage collector's goal is to keep HeapAlloc ≤ NextGC. At the end of each GC cycle, the target for the next cycle is computed based on the amount of reachable data and the value of GOGC.
   ...
   * @param bySize {Array.<module:model/MemStatsRespResultBySizeInner>} BySize reports per-size class allocation statistics. BySize[N] gives statistics for allocations of size S where BySize[N-1].Size < S ≤ BySize[N].Size. This does not report allocations larger than BySize[60].Size.
   */
