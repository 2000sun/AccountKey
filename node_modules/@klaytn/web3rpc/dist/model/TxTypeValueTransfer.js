 ...
 */
/**
 * The TxTypeValueTransfer model module.
 * @module model/TxTypeValueTransfer
 * @version 0.9.9
 */
var TxTypeValueTransfer = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>TxTypeValueTransfer</code>.
   * TxTypeValueTransfer is used when a user wants to send KLAY. For more information, see TxTypeValueTransfer.
   * @alias module:model/TxTypeValueTransfer
   * @param typeInt {Number} The integer indicating TxTypeValueTransfer 8
   ...
   */
  function TxTypeValueTransfer(typeInt, from, to, value) {
    _classCallCheck(this, TxTypeValueTransfer);
    TxTypeValueTransfer.initialize(this, typeInt, from, to, value);
  }
   ...
   */
  _createClass(TxTypeValueTransfer, null, [{
    key: "initialize",
    value: function initialize(obj, typeInt, from, to, value) {
      obj['typeInt'] = typeInt;
      obj['from'] = from;
      obj['to'] = to;
      obj['value'] = value;
    ...
    /**
     * Constructs a <code>TxTypeValueTransfer</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TxTypeValueTransfer} obj Optional instance to populate.
     * @return {module:model/TxTypeValueTransfer} The populated <code>TxTypeValueTransfer</code> instance.
     */
  }, {
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new TxTypeValueTransfer();
    ...
    /**
     * Validates the JSON data with respect to <code>TxTypeValueTransfer</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TxTypeValueTransfer</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(TxTypeValueTransfer.RequiredProperties),
        _step;
      try {
...
TxTypeValueTransfer.RequiredProperties = ["typeInt", "from", "to", "value"];

/**
 * The integer indicating TxTypeValueTransfer 8
 * @member {Number} typeInt
 */
TxTypeValueTransfer.prototype['typeInt'] = undefined;

/**
 * The address from which the transaction is sent.
 * @member {String} from
 */
TxTypeValueTransfer.prototype['from'] = undefined;

/**
 * The address to which the transaction is directed.
 * @member {String} to
 */
TxTypeValueTransfer.prototype['to'] = undefined;
 ...
 * @member {String} gas
 */
TxTypeValueTransfer.prototype['gas'] = undefined;
 ...
 */
TxTypeValueTransfer.prototype['gasPrice'] = undefined;

/**
 * (optional) Integer of a nonce.
 * @member {String} nonce
 */
TxTypeValueTransfer.prototype['nonce'] = undefined;

/**
 * Integer of the value sent with this transaction.
 * @member {String} value
 */
TxTypeValueTransfer.prototype['value'] = undefined;
var _default = exports["default"] = TxTypeValueTransfer;