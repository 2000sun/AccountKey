 ...
 */
/**
 * The TxTypeFeeDelegatedCancelWithRatio model module.
 * @module model/TxTypeFeeDelegatedCancelWithRatio
 * @version 0.9.9
 */
var TxTypeFeeDelegatedCancelWithRatio = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>TxTypeFeeDelegatedCancelWithRatio</code>.
   * @alias module:model/TxTypeFeeDelegatedCancelWithRatio
   * @param typeInt {Number} The integer indicating TxTypeFeeDelegatedCancelWithRatio: 58
   ...
   */
  function TxTypeFeeDelegatedCancelWithRatio(typeInt, from, feePayer, feeRatio) {
    _classCallCheck(this, TxTypeFeeDelegatedCancelWithRatio);
    TxTypeFeeDelegatedCancelWithRatio.initialize(this, typeInt, from, feePayer, feeRatio);
  }
   ...
   */
  _createClass(TxTypeFeeDelegatedCancelWithRatio, null, [{
    key: "initialize",
    value: function initialize(obj, typeInt, from, feePayer, feeRatio) {
      obj['typeInt'] = typeInt;
      obj['from'] = from;
    ...
    /**
     * Constructs a <code>TxTypeFeeDelegatedCancelWithRatio</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TxTypeFeeDelegatedCancelWithRatio} obj Optional instance to populate.
     * @return {module:model/TxTypeFeeDelegatedCancelWithRatio} The populated <code>TxTypeFeeDelegatedCancelWithRatio</code> instance.
     */
  }, {
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new TxTypeFeeDelegatedCancelWithRatio();
    ...
    /**
     * Validates the JSON data with respect to <code>TxTypeFeeDelegatedCancelWithRatio</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TxTypeFeeDelegatedCancelWithRatio</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(TxTypeFeeDelegatedCancelWithRatio.RequiredProperties),
        _step;
      try {
...
TxTypeFeeDelegatedCancelWithRatio.RequiredProperties = ["typeInt", "from", "feePayer", "feeRatio"];

/**
 * The integer indicating TxTypeFeeDelegatedCancelWithRatio: 58
 * @member {Number} typeInt
 */
TxTypeFeeDelegatedCancelWithRatio.prototype['typeInt'] = undefined;

/**
 * The address from which the transaction is sent.
 * @member {String} from
 */
TxTypeFeeDelegatedCancelWithRatio.prototype['from'] = undefined;
 ...
 * @member {String} gas
 */
TxTypeFeeDelegatedCancelWithRatio.prototype['gas'] = undefined;

/**
 * (optional, default: 25000000000 Peb) Integer of the gasPrice used for each paid gas.
 * @member {String} gasPrice
 */
TxTypeFeeDelegatedCancelWithRatio.prototype['gasPrice'] = undefined;

/**
 * (optional) Integer of a nonce.
 * @member {String} nonce
 */
TxTypeFeeDelegatedCancelWithRatio.prototype['nonce'] = undefined;

/**
 * The fee payer address of the transaction.
 * @member {String} feePayer
 */
TxTypeFeeDelegatedCancelWithRatio.prototype['feePayer'] = undefined;
 ...
 */
TxTypeFeeDelegatedCancelWithRatio.prototype['feeRatio'] = undefined;
 ...
 */
TxTypeFeeDelegatedCancelWithRatio.prototype['signatures'] = undefined;
var _default = exports["default"] = TxTypeFeeDelegatedCancelWithRatio;