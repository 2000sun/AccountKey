 ...
 */
/**
 * The TxTypeFeeDelegatedSmartContractExecution model module.
 * @module model/TxTypeFeeDelegatedSmartContractExecution
 * @version 0.9.9
 */
var TxTypeFeeDelegatedSmartContractExecution = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>TxTypeFeeDelegatedSmartContractExecution</code>.
   * @alias module:model/TxTypeFeeDelegatedSmartContractExecution
   * @param typeInt {Number} The integer indicating TxTypeFeeDelegatedSmartContractExecution: 49
   ...
   */
  function TxTypeFeeDelegatedSmartContractExecution(typeInt, from, to, value, input, feePayer) {
    _classCallCheck(this, TxTypeFeeDelegatedSmartContractExecution);
    TxTypeFeeDelegatedSmartContractExecution.initialize(this, typeInt, from, to, value, input, feePayer);
  }
   ...
   */
  _createClass(TxTypeFeeDelegatedSmartContractExecution, null, [{
    key: "initialize",
    value: function initialize(obj, typeInt, from, to, value, input, feePayer) {
      obj['typeInt'] = typeInt;
      obj['from'] = from;
      obj['to'] = to;
      obj['value'] = value;
    ...
    /**
     * Constructs a <code>TxTypeFeeDelegatedSmartContractExecution</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TxTypeFeeDelegatedSmartContractExecution} obj Optional instance to populate.
     * @return {module:model/TxTypeFeeDelegatedSmartContractExecution} The populated <code>TxTypeFeeDelegatedSmartContractExecution</code> instance.
     */
  }, {
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new TxTypeFeeDelegatedSmartContractExecution();
    ...
    /**
     * Validates the JSON data with respect to <code>TxTypeFeeDelegatedSmartContractExecution</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TxTypeFeeDelegatedSmartContractExecution</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(TxTypeFeeDelegatedSmartContractExecution.RequiredProperties),
        _step;
      try {
...
TxTypeFeeDelegatedSmartContractExecution.RequiredProperties = ["typeInt", "from", "to", "value", "input", "feePayer"];

/**
 * The integer indicating TxTypeFeeDelegatedSmartContractExecution: 49
 * @member {Number} typeInt
 */
TxTypeFeeDelegatedSmartContractExecution.prototype['typeInt'] = undefined;

/**
 * The address from which the transaction is sent.
 * @member {String} from
 */
TxTypeFeeDelegatedSmartContractExecution.prototype['from'] = undefined;

/**
 * The address to which the transaction is directed.
 * @member {String} to
 */
TxTypeFeeDelegatedSmartContractExecution.prototype['to'] = undefined;
 ...
 * @member {String} gas
 */
TxTypeFeeDelegatedSmartContractExecution.prototype['gas'] = undefined;

/**
 * (optional, default: 25000000000 Peb) Integer of the gasPrice used for each paid gas.
 * @member {String} gasPrice
 */
TxTypeFeeDelegatedSmartContractExecution.prototype['gasPrice'] = undefined;

/**
 * (optional) Integer of a nonce.
 * @member {String} nonce
 */
TxTypeFeeDelegatedSmartContractExecution.prototype['nonce'] = undefined;

/**
 * Integer of the value sent with this transaction.
 * @member {String} value
 */
TxTypeFeeDelegatedSmartContractExecution.prototype['value'] = undefined;

/**
 * The data sent along with the transaction.
 * @member {String} input
 */
TxTypeFeeDelegatedSmartContractExecution.prototype['input'] = undefined;

/**
 * The fee payer address of the transaction.
 * @member {String} feePayer
 */
TxTypeFeeDelegatedSmartContractExecution.prototype['feePayer'] = undefined;
 ...
 */
TxTypeFeeDelegatedSmartContractExecution.prototype['signatures'] = undefined;
var _default = exports["default"] = TxTypeFeeDelegatedSmartContractExecution;