 ...
 */
/**
 * The KlayCallObject model module.
 * @module model/KlayCallObject
 * @version 0.9.9
 */
var KlayCallObject = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>KlayCallObject</code>.
   * The transaction call object. See the next table for the object&#39;s properties.
   * @alias module:model/KlayCallObject
   */
  function KlayCallObject() {
    _classCallCheck(this, KlayCallObject);
    KlayCallObject.initialize(this);
  }
   ...
   */
  _createClass(KlayCallObject, null, [{
    key: "initialize",
    value: function initialize(obj) {}

    /**
     * Constructs a <code>KlayCallObject</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/KlayCallObject} obj Optional instance to populate.
     * @return {module:model/KlayCallObject} The populated <code>KlayCallObject</code> instance.
     */
  }, {
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new KlayCallObject();
    ...
    /**
     * Validates the JSON data with respect to <code>KlayCallObject</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>KlayCallObject</code>.
     */
  }, {
    key: "validateJSON",
 ...
 * @member {String} input
 */
KlayCallObject.prototype['input'] = undefined;
var _default = exports["default"] = KlayCallObject;